...
//       }
//     }
//   }, [productName, productDescription, imageURL, phoneNumber, attemptedNext]);
...
//         Please fill in all the required fields.
//       </Alert>
//       <p class="text-red-500" style={{marginLeft:'355px'}}>Fill All Required Fields to Continue <span>*</span></p>
//       <div className="relative isolate px-6 pt-14 lg:px-8 z-index-1">
//         <TextArea />
//         <div
//           className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
...
//         </div>
//         <Tabs isDisabled={isAnyFieldEmpty()} />
//         {/* {!isAnyFieldEmpty() && <Tabs isDisabled={isAnyFieldEmpty()} />} */}
//         {/* <Tabs isDisabled={isAnyFieldEmpty()} /> */}
//         <Footer />
